...
# [КВАС](https://forum.keenetic.com/topic/14415-пробуем-квас-shadowsocks-и-другие-vpn-клиенты) - защита Вашего соединения #
...
## Установка пакета
Процедуру установки можно просмотреть по этой [ссылке](https://github.com/qzeleza/kvas/wiki/Установка-пакета) 
...
- Для проведения тестов, в проекте ранее использовался пакет [BATS](https://github.com/bats-core/bats-core/blob/master/LICENSE.md) от нескольких [АВТОРОВ](https://github.com/bats-core/bats-core/blob/master/AUTHORS).
